...
Z_k1k1(11,:) = Z_k1k1(11,:) - mean(Z_k1k1(11,:));
Z_k1k1(12,:) = Z_k1k1(12,:);
da = da;
de = de - mean(de);
dr = dr;
...
ACx = ones(5,size_data_eval);
ACx(2,:) = (Z_k1k1(11,data_evaluation)); %alpha
ACx(3,:) = alpha2(data_evaluation); %alpha^2
...
%CxTc = ParamCx(6,1);
%Data Validation
ACx = ones(5,size_data_val);
ACx(2,:) = (Z_k1k1(11,data_validation)); %alpha
ACx(3,:) = alpha2(data_validation); %alpha^2
